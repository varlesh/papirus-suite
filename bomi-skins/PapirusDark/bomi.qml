...
B.AppWithDock {
    ...
    bottomControls: Item {
        ...
        Rectangle {
            ...
            Rectangle {
                id: right
                color: "#222222"; visible: fs; width: fs ? (timeText2.implicitWidth + 10) : 0
                ...
                B.TimeDuration {
                    ...
                    textStyle {
                        color: "#909090"; font.pixelSize: 14
        ...
        Rectangle {
            id: bottom
            visible: !fs
            color: "#222222"; anchors.bottom: parent.bottom
            width: parent.width;
            ...
            Item {
                ...
                B.Text {
                    ...
                    textStyle {
                        elide: Text.ElideRight; color: "#909090";
                        verticalAlignment: Text.AlignVCenter
                    }
                }
                B.TimeDuration {
                    ...
                    textStyle { color: "#909090"; verticalAlignment: Text.AlignVCenter }
                }
            }
        }
    }
